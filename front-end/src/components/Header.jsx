  ...
  return (
    <header className="shadow-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-8 py-2">
        ...
        <div className="p flex items-center rounded-full border border-gray-300 py-1 pr-4 pl-6 shadow-md">
        ...
        <div className="p flex items-center gap-2 rounded-full border border-gray-300 py-1 pr-4 pl-6 shadow-md">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
